...
Der TSP-X.509 nonQES (eGK) MUSS C.CH.ENCgemäß Tab_PKI_233 umsetzen. **[\<=]**
...
Der TSP-X.509 nonQES MUSS C.CM.TLS-CS gemäß Tab_PKI_267umsetzen. **[\<=]**
...
Der TSP-X.509 nonQES MUSS dasZertifikatsprofil C.SGD-HSM.AUT nach Tab_PKI_296
umsetzen.​​ **[\<=]**
...
Der TSP-X.509 QES MUSS fürdie Zertifikate dervon ihm betriebenen CAs die
...
(aAdG und aAdG-NetG-TI) die Berücksichtigung der für die ECC-Migration
aufgeführten Hinweise und Anforderungen. Letztere sind gekennzeichnet durch
die Ergänzung „(ECC-Migration)“ im Titel der relevanten Anforderungen.
...
Der Anbieter einer aAdG oder aAdG-NetG-TI MUSS sicherstellen, dass die initiale
Einbringung des aktuell gültigen TSL-Signer-CA-Zertifikats als
TI-Vertrauensanker in Dienste der aAdG oder der aAdG-NetG-TI nachweislich
sicher vor Manipulation vorgenommen wird. **[\<=]**
...
Der Anbieter einer aAdG oder aAdG-NetG-TI MUSS sicherstellen, dass die initiale
Einbringung der TSL-Datei in Dienste der aAdG oder der aAdG-NetG-TI
nachweislich sicher vor Manipulation vorgenommen wird. **[\<=]**
...
Komponenten (Produkttypen der TI, aAdG und aAdG-NetG-TI), die Zertifikate
prüfen, DÜRFEN (abweichend von [RFC6960]) je OCSP-Request NICHT mehr als
den Status für genau ein Zertifikat abfragen. Ist hierbei die Verwendung der
...
Die Produkttypen TSL-Dienst, gematik Root-CA, TSP-X.509 nonQES und TSP-X.509 QES
MÜSSEN sicherstellen, dass dieAngabe zu den
ZeitpunktenproducedAt,thisUpdateundnextUpdatespezifikationskonformgemäß
Tab_PKI_292 erfolgt. **[\<=]**
...
aAndere Anwendungen des Gesundheitswesens ohne Zugriff auf Dienste der TI in
...
- [Tabelle-120] -  Tab_PKI_288 Generisches Zertifikatsprofil für die SMC-B - Weitere Ärztliche Institutionen
...
[Abbildung-1]:           gemSpec_PKI_V2.10.2.attachments/9860334542679923714.emf
[Abbildung-3]:           gemSpec_PKI_V2.10.2.attachments/41448625434249942.emf
[Abbildung-4]:           gemSpec_PKI_V2.10.2.attachments/977682913005749266.wmf
[Abbildung-5]:           gemSpec_PKI_V2.10.2.attachments/2568216454139147218.emf
[Abbildung-6]:           gemSpec_PKI_V2.10.2.attachments/2832642052639720632.jpg
[Abbildung-7]:           gemSpec_PKI_V2.10.2.attachments/11515954078294821000.emf
[Abbildung-8]:           gemSpec_PKI_V2.10.2.attachments/8198595218391306627.emf
[Abbildung-9]:           gemSpec_PKI_V2.10.2.attachments/11413418770414368777.emf
[Abbildung-10]:          gemSpec_PKI_V2.10.2.attachments/697364341473611535.png
[Abbildung-11]:          gemSpec_PKI_V2.10.2.attachments/2773891538260872307.emf
[Img-011]:               gemSpec_PKI_V2.10.2.attachments/16430827375828737306.emf
[Abbildung-13]:          gemSpec_PKI_V2.10.2.attachments/9187492111909383948.emf
[Abbildung-14]:          gemSpec_PKI_V2.10.2.attachments/5291871770097294234.png
[Abbildung-15]:          gemSpec_PKI_V2.10.2.attachments/3869873291169113381.png
[Abbildung-16]:          gemSpec_PKI_V2.10.2.attachments/9165209288795990020.emf
[Abbildung-17]:          gemSpec_PKI_V2.10.2.attachments/12645155460962043521.emf
[Abbildung-18]:          gemSpec_PKI_V2.10.2.attachments/7613049471108825882.emf
[Abbildung-19]:          gemSpec_PKI_V2.10.2.attachments/13853463435789655221.png
[Abbildung-20]:          gemSpec_PKI_V2.10.2.attachments/12158266775686994033.png
[Abbildung-21]:          gemSpec_PKI_V2.10.2.attachments/8999448966524760507.emf
[Img-021]:               gemSpec_PKI_V2.10.2.attachments/11307977339773209788.png
[Tbl-001]:               #Tbl-001 (&93834811899072)
[Tbl-002]:               #Tbl-002 (&93834810816152)
[Tabelle-1]:             #Tabelle-1 (&93834810838112)
[Tabelle-2]:             #Tabelle-2 (&93834810845976)
[Tbl-005]:               #Tbl-005 (&93834772235000)
[Tbl-006]:               #Tbl-006 (&93834772251640)
[Tabelle-3]:             #Tabelle-3 (&93834772266072)
[Tabelle-4]:             #Tabelle-4 (&93834801616072)
[Tabelle-5]:             #Tabelle-5 (&93834801651456)
[Tabelle-6]:             #Tabelle-6 (&93834781669336)
[Tabelle-7]:             #Tabelle-7 (&93834801556240)
[Tabelle-8]:             #Tabelle-8 (&93834810736776)
[Tbl-013]:               #Tbl-013 (&93834783622208)
[Tbl-014]:               #Tbl-014 (&93834811161600)
[Tabelle-9]:             #Tabelle-9 (&93834768782920)
[Tabelle-10]:            #Tabelle-10 (&93834768824024)
[Tabelle-11]:            #Tabelle-11 (&93834783499896)
[Tabelle-12]:            #Tabelle-12 (&93834799206696)
[Tabelle-13]:            #Tabelle-13 (&93834799242016)
[Tabelle-14]:            #Tabelle-14 (&93834776368896)
[Tabelle-15]:            #Tabelle-15 (&93834802631320)
[Tabelle-16]:            #Tabelle-16 (&93834800996176)
[Tabelle-17]:            #Tabelle-17 (&93834777639224)
[Tabelle-18]:            #Tabelle-18 (&93834781810232)
[Tabelle-19]:            #Tabelle-19 (&93834776235856)
[Tabelle-20]:            #Tabelle-20 (&93834771824704)
[Tabelle-21]:            #Tabelle-21 (&93834781624480)
[Tabelle-22]:            #Tabelle-22 (&93834783870208)
[Tabelle-23]:            #Tabelle-23 (&93834775665680)
[Tabelle-24]:            #Tabelle-24 (&93834765253872)
[Tabelle-25]:            #Tabelle-25 (&93834799141432)
[Tabelle-26]:            #Tabelle-26 (&93834799984904)
[Tabelle-27]:            #Tabelle-27 (&93834795223488)
[Tabelle-28]:            #Tabelle-28 (&93834802479192)
[Tabelle-29]:            #Tabelle-29 (&93834764319528)
[Tabelle-30]:            #Tabelle-30 (&93834810979744)
[Tabelle-31]:            #Tabelle-31 (&93834781322224)
[Tabelle-32]:            #Tabelle-32 (&93834811300008)
[Tabelle-33]:            #Tabelle-33 (&93834775150032)
[Tabelle-34]:            #Tabelle-34 (&93834775417512)
[Tabelle-35]:            #Tabelle-35 (&93834775440952)
[Tabelle-36]:            #Tabelle-36 (&93834768097248)
[Tabelle-37]:            #Tabelle-37 (&93834768312272)
[Tabelle-38]:            #Tabelle-38 (&93834785481656)
[Tabelle-39]:            #Tabelle-39 (&93834771467976)
[Tabelle-40]:            #Tabelle-40 (&93834771677504)
[Tabelle-41]:            #Tabelle-41 (&93834775978776)
[Tabelle-42]:            #Tabelle-42 (&93834776176648)
[Tabelle-43]:            #Tabelle-43 (&93834804360464)
[Tabelle-44]:            #Tabelle-44 (&93834778077784)
[Tabelle-45]:            #Tabelle-45 (&93834764541280)
[Tabelle-46]:            #Tabelle-46 (&93834764746104)
[Tabelle-47]:            #Tabelle-47 (&93834764904832)
[Tabelle-48]:            #Tabelle-48 (&93834767382040)
[Tabelle-49]:            #Tabelle-49 (&93834767572024)
[Tabelle-50]:            #Tabelle-50 (&93834801172424)
[Tabelle-51]:            #Tabelle-51 (&93834801351848)
[Tabelle-52]:            #Tabelle-52 (&93834768956208)
[Tabelle-53]:            #Tabelle-53 (&93834769171448)
[Tabelle-54]:            #Tabelle-54 (&93834799336136)
[Tabelle-55]:            #Tabelle-55 (&93834777092888)
[Tabelle-56]:            #Tabelle-56 (&93834777183576)
[Tabelle-57]:            #Tabelle-57 (&93834777231592)
[Tabelle-58]:            #Tabelle-58 (&93834777327168)
[Tabelle-59]:            #Tabelle-59 (&93834777359272)
[Tabelle-60]:            #Tabelle-60 (&93834777428072)
[Tabelle-61]:            #Tabelle-61 (&93834777464448)
[Tabelle-62]:            #Tabelle-62 (&93834777477960)
[Tabelle-63]:            #Tabelle-63 (&93834777514568)
[Tabelle-64]:            #Tabelle-64 (&93834777541200)
[Tabelle-65]:            #Tabelle-65 (&93834798460336)
[Tabelle-66]:            #Tabelle-66 (&93834798547128)
[Tabelle-67]:            #Tabelle-67 (&93834798684248)
[Tabelle-68]:            #Tabelle-68 (&93834798773192)
[Tabelle-69]:            #Tabelle-69 (&93834798909336)
[Tabelle-70]:            #Tabelle-70 (&93834802087752)
[Tabelle-71]:            #Tabelle-71 (&93834802178760)
[Tabelle-72]:            #Tabelle-72 (&93834776562888)
[Tabelle-73]:            #Tabelle-73 (&93834776636496)
[Tabelle-74]:            #Tabelle-74 (&93834776787360)
[Tabelle-75]:            #Tabelle-75 (&93834776887728)
[Tabelle-76]:            #Tabelle-76 (&93834776916648)
[Tabelle-77]:            #Tabelle-77 (&93834777008960)
[Tabelle-78]:            #Tabelle-78 (&93834809521032)
[Tabelle-79]:            #Tabelle-79 (&93834809537328)
[Tabelle-80]:            #Tabelle-80 (&93834809627152)
[Tabelle-81]:            #Tabelle-81 (&93834809682232)
[Tabelle-82]:            #Tabelle-82 (&93834809708304)
[Tabelle-83]:            #Tabelle-83 (&93834785064544)
[Tabelle-84]:            #Tabelle-84 (&93834785166528)
[Tabelle-85]:            #Tabelle-85 (&93834785215680)
[Tabelle-86]:            #Tabelle-86 (&93834785290264)
[Tabelle-87]:            #Tabelle-87 (&93834785346424)
[Tabelle-88]:            #Tabelle-88 (&93834803997096)
[Tabelle-89]:            #Tabelle-89 (&93834804090568)
[Tabelle-90]:            #Tabelle-90 (&93834804154336)
[Tabelle-91]:            #Tabelle-91 (&93834782657792)
[Tabelle-92]:            #Tabelle-92 (&93834783198824)
[Tabelle-93]:            #Tabelle-93 (&93834783256464)
[Tabelle-94]:            #Tabelle-94 (&93834783364640)
[Tabelle-95]:            #Tabelle-95 (&93834770567568)
[Tabelle-96]:            #Tabelle-96 (&93834770639912)
[Tabelle-97]:            #Tabelle-97 (&93834770888776)
[Tabelle-98]:            #Tabelle-98 (&93834770938616)
[Tabelle-99]:            #Tabelle-99 (&93834792138336)
[Tabelle-100]:           #Tabelle-100 (&93834792299512)
[Tabelle-101]:           #Tabelle-101 (&93834793296624)
[Tabelle-102]:           #Tabelle-102 (&93834793320456)
[Tabelle-103]:           #Tabelle-103 (&93834793430424)
[Tabelle-104]:           #Tabelle-104 (&93834793481432)
[Tabelle-105]:           #Tabelle-105 (&93834793534976)
[Tabelle-106]:           #Tabelle-106 (&93834793565872)
[Tabelle-107]:           #Tabelle-107 (&93834793599384)
[Tabelle-108]:           #Tabelle-108 (&93834793630472)
[Tabelle-109]:           #Tabelle-109 (&93834793712944)
[Tabelle-110]:           #Tabelle-110 (&93834772428680)
[Tabelle-111]:           #Tabelle-111 (&93834772660016)
[Tabelle-112]:           #Tabelle-112 (&93834772885352)
[Tabelle-113]:           #Tabelle-113 (&93834772907416)
[Tabelle-114]:           #Tabelle-114 (&93834773126448)
[Tabelle-115]:           #Tabelle-115 (&93834773346120)
[Tabelle-116]:           #Tabelle-116 (&93834773366448)
[Tabelle-117]:           #Tabelle-117 (&93834773585840)
[Tabelle-118]:           #Tabelle-118 (&93834773608392)
[Tabelle-119]:           #Tabelle-119 (&93834773849104)
[Tabelle-120]:           #Tabelle-120 (&93834774023736)
[Tbl-127]:               #Tbl-127 (&93834774244568)
[Tbl-128]:               #Tbl-128 (&93834774953208)
[Tbl-129]:               #Tbl-129 (&93834778446704)
[Tbl-130]:               #Tbl-130 (&93834778481040)
[Tabelle-121]:           #Tabelle-121 (&93834778693264)
[Tabelle-122]:           #Tabelle-122 (&93834778919416)
[Tabelle-123]:           #Tabelle-123 (&93834779146072)
[Tabelle-124]:           #Tabelle-124 (&93834779375576)
[Tabelle-125]:           #Tabelle-125 (&93834779551304)
[RFC5280]:               http://tools.ietf.org/html/rfc3280 (&93834800968432)
[RFC5280]:               http://tools.ietf.org/html/rfc3280 (&93834800973240)
[http://uri.etsi.org/TrstSvc/Svcstatus/inaccord]: http://uri.etsi.org/TrstSvc/Svcstatus/inaccord (&93834776893256)
[http://uri.etsi.org/TrstSvc/Svcstatus/revoked]: http://uri.etsi.org/TrstSvc/Svcstatus/revoked (&93834776901384)
[http://uri.etsi.org/TrstSvc/Svcstatus/expired]: http://uri.etsi.org/TrstSvc/Svcstatus/expired (&93834776906376)
[http://uri.etsi.org/TrstSvc/Svctype/unspecified]: http://uri.etsi.org/TrstSvc/Svctype/unspecified (&93834785364064)
[http://uri.etsi.org/TrstSvc/Svctype/unspecified]: http://uri.etsi.org/TrstSvc/Svctype/unspecified (&93834785366528)
[http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP]: http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP (&93834770980512)
[http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP/QC]: http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP/QC (&93834770981288)
[]:                      file:///C:/Work/Work/QES-PruefungPolicy/20200407_Entwurf_KorrekturRefrenzen_PKI.docx#_msocom_2 (&93834792115960)
[<ServiceHistory>]:      file:///D:/Work/TSL/TSL-XML_ListIssueDateTime2019-11-21T14_20_00Z.xml (&93834792118800)
[http://uri.etsi.org/TrstSvc/TrustedList/SvcInfoExt/ForeSignatures]: http://uri.etsi.org/TrstSvc/TrustedList/SvcInfoExt/ForeSignatures (&93834792119880)
[https://www.sogis.eu/documents/cc/crypto/SOGIS-Agreed-Cryptographic-Mechanisms-1.1.pdf]: https://www.sogis.eu/documents/cc/crypto/SOGIS-Agreed-Cryptographic-Mechanisms-1.1.pdf (&93834778486584)
[http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf]: http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf (&93834778591872)
[http://tools.ietf.org/html/rfc2109]: http://tools.ietf.org/html/rfc2109 (&93834778614472)
[http://tools.ietf.org/html/rfc3629]: http://tools.ietf.org/html/rfc3629 (&93834778619104)
[http://tools.ietf.org/html/rfc3739]: http://tools.ietf.org/html/rfc3739 (&93834778623736)
[http://tools.ietf.org/html/rfc4514]: http://tools.ietf.org/html/rfc4514 (&93834778628368)
[http://tools.ietf.org/html/rfc5019]: http://tools.ietf.org/html/rfc5019 (&93834778633024)
[http://tools.ietf.org/html/rfc5280]: http://tools.ietf.org/html/rfc5280 (&93834778637656)
[https://tools.ietf.org/html/rfc6960]: https://tools.ietf.org/html/rfc6960 (&93834778642288)
[https://tools.ietf.org/html/rfc3370]: https://tools.ietf.org/html/rfc3370 (&93834778646856)
[http://www.itu.int/rec/T-REC-X.509/]: http://www.itu.int/rec/T-REC-X.509/ (&93834778659992)
[http://www.itu.int/rec/T-REC-X.520/]: http://www.itu.int/rec/T-REC-X.520/ (&93834778665840)
[http://www.w3.org/TR/REC-xml/]: http://www.w3.org/TR/REC-xml/ (&93834778676320)
[http://www.w3.org/TR/xmldsig-core/]: http://www.w3.org/TR/xmldsig-core/ (&93834778684680)
