...
CVC) oder Kostenträger (Zugriffsprofil CHA.8 [gemSpec_PKI#Tab_PKI_254]) nicht
betroffen, da sie keinen Zugriff auf die entsprechenden Daten erlauben. Ebenso
sind SM-B mit Zugriffsprofil CHA.1 [gemSpec_PKI#Tab_PKI_254) nicht betroffen,
da sie dem Zugriff des Versicherten selbst in der KTR-AdV-Umgebung dienen.
...
Tabelle46: Tab_PKI_267 C.CM.TLS-CS Clientmodul-Authentisierung
...
Tabelle47: Tab_PKI_296  C.SGD-HSM.AUT  Authentisierung SGD-HSM
...
Tabelle48: Tab_PKI_211 GEM.R-CA\<n\> – Zentrale gematik Root-CA_nonQES der TI
...
Tabelle50: Tab_PKI_215 \<tsp\>.HBA-qCA\<n\> – Aussteller- CA_QES der TI
...
Tabelle52: Tab_PKI_214 C.GEM.CRL Zertifikatsprofil CRL-Signer
...
Tabelle53: Tab_PKI_252_01 C.TSL.SIG Zertifikatsprofil TSL-Signer
...
Organisation gemäß Tabelle Tab_PKI_254 entspricht.    Eine Ausnahme
...
CHAT.0 gemäß [gemSpec_PKI#Tab_PKI_254] besitzen. **[\<=]**
...
Stelle“ (vgl. Tab_PKI_254) die Berechtigung für die Zugriffsprofile in
...
Fachärzte für Arbeitsmedizin, Betriebsärzte.
...
oid_institution-rettungsleitstellen  
...
für G2 gemäß Tab_PKI_918). **[\<=]**

**GS-A_5126 - Zugriffsprofil einer gSMC-KT**

Der Kartenherausgeber MUSS sicherstellen, dass das CV-Gerätezertifikat einer
gSMC-KT alsFlaglisteden Wert’00 0000 0000 0002’hat(Zugriffsprofil54
fürG2gemäßTab_PKI_918). **[\<=]**

**GS-A_4623 - Zugriffsprofil eines HBA**

Der Kartenherausgeber MUSS sicherstellen, dass das CV-Gerätezertifikat eines
HBA alsFlaglisteden Wert’00 0000 0000 000C’hat(Zugriffsprofil53
fürG2gemäßTab_PKI_918). **[\<=]**

**GS-A_4624 - Zugriffsprofil einer SM-B**

Der Kartenherausgeber MUSS sicherstellen, dassdasCV-Gerätezertifikat einer SM-B
alsFlaglisteden Wert’00 0000 0000 0004’ hat(Zugriffsprofil55
fürG2gemäßTab_PKI_918). **[\<=]**
...
Rollen-Zugriffsprofilen) aus Tab_PKI_919, genau die zugeordnete Flaglist aus
...
aus Tab_PKI_919 zulässig für die Zugriffsprofile(b.1) aller HBA- und SMC-B
...
Tabelle56: Tab_PKI_266 Aufbau CAR für Karten der Generation 2
...
Tabelle57: Tab_PKI_901 Objektidentifier des öffentlichen Schlüssels eines
...
Tabelle58: Tab_PKI_902 Punkt Q des öffentlichen Schlüssels eines
CV-Zertifikats der Generation 2
...
Einzelflags gemäß TAB_PKI_918 erfolgen.

Tabelle60: Tab_PKI_904 Mögliche Objektidentifier OID\<sub\>flags\</sub\>in
...
Tabelle61: Tab_PKI_905 Zu signierende Nachricht M eines CV-Zertifikates
...
Tabelle62: Tab_PKI_906 Signatur der Nachricht M eines CV-Zertifikats
...
Tabelle63: Tab_PKI_907 Struktur und Inhalt eines CV-Zertifikat
...
Zahnärztin/Zahnarzt ist in die Tabelle Tab_PKI_918 aufgenommen worden: für
die beiden Berufsgruppen gibt es unterschiedliche CHAT-Werte gemäß den
...
(siehe Tab_PKI_919).        Beispiel: Ein TSP-CVC ist nur für die
...
Wert für die Flagliste des CA-Zertifikates des TSP-CVC in Tab_PKI_919
...
Tabelle76: TUC_PKI_001 „Periodische Aktualisierung TI-Vertrauensraum“
...
Tabelle77: TUC_PKI_013 „Import neuer TI-Vertrauensanker“
...
Tabelle80: TUC_PKI_017 „Lokalisierung Download-Adressen“
...
Tabelle82: TUC_PKI_016 „Download der TSL-Datei“
...
Tabelle83: TUC_PKI_019 „Prüfung der Aktualität der TSL“
...
Tabelle84: TUC_PKI_020 „XML-Dokument validieren“
...
Tabelle85: TUC_PKI_011 „Prüfung des TSL-Signer-Zertifikates“
...
Tabelle86: TUC_PKI_012 „XML-Signatur- Prüfung“
...
Tabelle88: TUC_PKI_018 „Zertifikatsprüfung in der TI“
...
Tabelle89: TUC_PKI_002 „Gültigkeitsprüfung des Zertifikats“
...
Tabelle90: TUC_PKI_003 „CA-Zertifikat in TSL-Informationen finden“
...
Tabelle91: TUC_PKI_004 „Mathematische Prüfung der Zertifikatssignatur“
...
Tabelle92: TUC_PKI_005 „Adresse für Status- und Sperrprüfung ermitteln“
...
Tabelle93: TUC_PKI_006 „OCSP-Abfrage“
...
Tabelle94: TUC_PKI_021 „CRL-Prüfung“
...
Tabelle95: TUC_PKI_009-01 „Rollenermittlung“
...
Tabelle96: TUC_PKI_007 „Prüfung Zertifikatstyp“
...
Tabelle97: Tab_PKI_273 Prüfparameter für TLS-Aufbau
...
Tabelle98: TUC_PKI_030 „QES-Zertifikatsprüfung“
...
Tabelle99: TUC_PKI_036 „BNetzA-VL Aktualisierung“
...
Tabelle101: Tab_PKI_908 Prüfung der Signatur eines CV-Zertifikats der
...
Tabelle102: Tab_PKI_909 Gültigkeit eines CV-Zertifikats der Generation 2 
...
Tabelle104: Tab_PKI_289 Struktur Nonce
...
Tabelle105: Tab_PKI_291 OCSP-Response Status Ergebnisse
...
Tabelle106: Tab_PKI_292 Zeiten in einer OCSP-Response
...
Tabelle107: Tab_PKI_293 Status der OCSP Antworten
...
Tabelle108: Tab_PKI_288 Struktur certHash
...
- [Tabelle-51] - Tab_PKI_253 C.GEM.OCSP Zertifikatsprofil OCSP-Signer
- [Tabelle-52] - Tab_PKI_214 C.GEM.CRL Zertifikatsprofil CRL-Signer
- [Tabelle-53] - Tab_PKI_252_01 C.TSL.SIG Zertifikatsprofil TSL-Signer
- [Tabelle-54] - Tab_PKI_254 Zugriffsprofile für eine Rollenauthentisierung
- [Tabelle-55] - Tab_PKI_255 Zugriffsprofile G2 für eine Authentisierung einer Funktionseinheit
- [Tabelle-56] - Tab_PKI_266 Aufbau CAR für Karten der Generation 2
- [Tabelle-57] - Tab_PKI_901 Objektidentifier des öffentlichen Schlüssels eines CV-Zertifikats der Generation 2
- [Tabelle-58] - Tab_PKI_902 Punkt Q des öffentlichen Schlüssels eines CV-Zertifikats der Generation 2
- [Tabelle-59] - Tab_PKI_258 Aufbau CHR
- [Tabelle-60] - Tab_PKI_904 Mögliche Objektidentifier OID
- [Tabelle-61] - Tab_PKI_905 Zu signierende Nachricht M eines CV-Zertifikates
- [Tabelle-62] - Tab_PKI_906 Signatur der Nachricht M eines CV-Zertifikats
- [Tabelle-63] - Tab_PKI_907 Struktur und Inhalt eines CV-Zertifikat
- [Tabelle-64] - Tab_PKI_912 CA CV-Zertifikate für 256 bit ELC-Schlüssel, insgesamt 220 Oktett
- [Tabelle-65] - Tab_PKI_913 CA CV-Zertifikate für 384 bit ELC-Schlüssel, insgesamt 285 Oktett
- [Tabelle-66] - Tab_PKI_914 CA CV-Zertifikate für 512 bit ELC-Schlüssel, insgesamt 352 Oktett
- [Tabelle-67] - Tab_PKI_937 Cross-CV-Zertifikat für ELC-Schlüssel
- [Tabelle-68] - Tab_PKI_915 Endnutzer-CV-Zertifikate für 256 bit ELC-Schlüssel, insgesamt 222 Oktett
- [Tabelle-69] - Tab_PKI_916 Endnutzer-CV-Zertifikate für 384 bit ELC-Schlüssel, insgesamt 287 Oktett
- [Tabelle-70] - Tab_PKI_917 Endnutzer-CV-Zertifikate für 512 bit ELC-Schlüssel, insgesamt 354 Oktett
- [Tabelle-71] - Tab_PKI_910 TI-PKI, Bedeutung der Bits innerhalb der Flagliste eines CHAT
- [Tabelle-72] - Tab_PKI_918 Abbildung von Rollenberechtigungen Zugriffsprofilen auf äquivalente Flaglisten
- [Tabelle-73] - Tab_PKI_919 Sub-CA-Flaglisten nach Kartentyp (G2) und Zugriffsprofilen
- [Tabelle-74] - Tab_PKI_911 CMS-PKI, Bedeutung der Bits innerhalb der Flagliste eines CHAT
- [Tabelle-75] - Tab_PKI_271 Erlaubte URIs als Inhalte des TSL-Elements ServiceStatus
- [Tabelle-76] - TUC_PKI_001 „Periodische Aktualisierung TI-Vertrauensraum“
- [Tabelle-77] - TUC_PKI_013 „Import neuer TI-Vertrauensanker“
- [Tabelle-78] - Gültige Werte für den TI-Vertrauensankerwechsel
- [Tabelle-79] - Beispiel für den TSL-Eintrag zum Wechsel des TSL-Signer-CA-Zertifikats
- [Tabelle-80] - TUC_PKI_017 „Lokalisierung Download-Adressen“
- [Tabelle-81] - Tab_PKI_272 Gültige Werte zur Download-Adresse
- [Tabelle-82] - TUC_PKI_016 „Download der TSL-Datei“
- [Tabelle-83] - TUC_PKI_019 „Prüfung der Aktualität der TSL“
- [Tabelle-84] - TUC_PKI_020 „XML-Dokument validieren“
- [Tabelle-85] - TUC_PKI_011 „Prüfung des TSL-Signer-Zertifikates“
- [Tabelle-86] - TUC_PKI_012 „XML-Signatur- Prüfung“
- [Tabelle-87] - Tab_PKI_294 TSL Zeitparameter
- [Tabelle-88] - TUC_PKI_018 „Zertifikatsprüfung in der TI“
- [Tabelle-89] -  TUC_PKI_002 „Gültigkeitsprüfung des Zertifikats“
- [Tabelle-90] - TUC_PKI_003 „CA-Zertifikat in TSL-Informationen finden“
- [Tabelle-91] - TUC_PKI_004 „Mathematische Prüfung der Zertifikatssignatur“
- [Tabelle-92] - TUC_PKI_005 „Adresse für Status- und Sperrprüfung ermitteln“
- [Tabelle-93] - TUC_PKI_006 „OCSP-Abfrage“
- [Tabelle-94] - TUC_PKI_021 „CRL-Prüfung“
- [Tabelle-95] - TUC_PKI_009-01 „Rollenermittlung“
- [Tabelle-96] - TUC_PKI_007 „Prüfung Zertifikatstyp“
- [Tabelle-97] - Tab_PKI_273 Prüfparameter für TLS-Aufbau
- [Tabelle-98] - TUC_PKI_030 „QES-Zertifikatsprüfung“
- [Tabelle-99] - TUC_PKI_036 „BNetzA-VL Aktualisierung“
- [Tabelle-100] - Tab_PKI_274 Fehlercodes des SubCompTyps PKI bei TSL- und Zertifikatsprüfung
- [Tabelle-101] - Tab_PKI_908 Prüfung der Signatur eines CV-Zertifikats der Generation 2 mit Hilfe des CV-Zertifikats des Herausgebers
- [Tabelle-102] -  Tab_PKI_909 Gültigkeit eines CV-Zertifikats der Generation 2 
- [Tabelle-103] - Tab_PKI_290 Struktur certID in OCSP-Request/Response 
- [Tabelle-104] - Tab_PKI_289 Struktur Nonce
- [Tabelle-105] - Tab_PKI_291 OCSP-Response Status Ergebnisse
- [Tabelle-106] - Tab_PKI_292 Zeiten in einer OCSP-Response
- [Tabelle-107] - Tab_PKI_293 Status der OCSP Antworten
- [Tabelle-108] - Tab_PKI_288 Struktur certHash
- [Tabelle-109] - Tab_SMCB_KZBV_ZA SMC-B-Zertifikate für Zahnarzt (Sektor KZBV)
- [Tabelle-110] - Tab_SMCB_KV-T SMC-B-Zertifikate für Sektoren der KBV
- [Tabelle-111] - Tab_SMCB_DKTIG SMC-B-Zertifikate für Sektor der DKTIG
- [Tabelle-112] - Tab_SMCB_TID_DKTIG  Aufbau Telematik-ID in SMC-B-Zertifikaten der DKTIG
- [Tabelle-113] - Tab_SMB_KTR SM-B-Zertifikate für Mitarbeiter Kostenträger
- [Tabelle-114] - Tab_SMB_ADV_KTR SM-B-Zertifikate für die AdV-Umgebungen der Kostenträger
- [Tabelle-115] - Tab_SMB_TID_GKVSV Aufbau Telematik-ID in SM-B-Zertifikaten des GKV-SV
- [Tabelle-116] - Tab_SMCB_APO SMC-B-Zertifikate für Apotheker
- [Tabelle-117] - Tab_SMCB_TID_APO Aufbau Telematik-ID in SMC-B-Zertifikaten der Apotheker
- [Tabelle-118] - Tab_SMCB_ORG_Gen - Generisches Zertifikatsprofil für die SMC-B-ORG
- [Tabelle-119] - Tab_PKI_286 Generisches Zertifikatsprofil für die SMC-B - Weitere Leistungserbringerinstitution
- [Tabelle-120] -  Tab_PKI_287 Generisches Zertifikatsprofil für die SMC-B - Weitere Ärztliche Institutionen
...
- [Tabelle-124] - Tab_HBA_APO HBA-Zertifikate (AUT, ENC, QES) für Apotheker
- [Tabelle-125] - Tab_PKI_285 Generisches Zertifikatsprofil (C.HP.AUT, C.HP.ENC, C.HP.QES) für BA - Weitere Leistungserbringer
...
SOG-IS Crypto Evaluation Scheme Agreed Cryptographic Mechanisms. Version
1.1, June 2018.
...
gemäß [gemSpec_OID#GS-A_4442-01]
...
[Abbildung-1]:           gemSpec_PKI_V2.10.5.attachments/9860334542679923714.emf
[Abbildung-3]:           gemSpec_PKI_V2.10.5.attachments/41448625434249942.emf
[Abbildung-4]:           gemSpec_PKI_V2.10.5.attachments/977682913005749266.wmf
[Abbildung-5]:           gemSpec_PKI_V2.10.5.attachments/2568216454139147218.emf
[Abbildung-6]:           gemSpec_PKI_V2.10.5.attachments/2832642052639720632.jpg
[Abbildung-7]:           gemSpec_PKI_V2.10.5.attachments/11515954078294821000.emf
[Abbildung-8]:           gemSpec_PKI_V2.10.5.attachments/8198595218391306627.emf
[Abbildung-9]:           gemSpec_PKI_V2.10.5.attachments/11413418770414368777.emf
[Abbildung-10]:          gemSpec_PKI_V2.10.5.attachments/697364341473611535.png
[Abbildung-11]:          gemSpec_PKI_V2.10.5.attachments/2773891538260872307.emf
[Img-011]:               gemSpec_PKI_V2.10.5.attachments/16430827375828737306.emf
[Abbildung-13]:          gemSpec_PKI_V2.10.5.attachments/9187492111909383948.emf
[Abbildung-14]:          gemSpec_PKI_V2.10.5.attachments/5291871770097294234.png
[Abbildung-15]:          gemSpec_PKI_V2.10.5.attachments/3869873291169113381.png
[Abbildung-16]:          gemSpec_PKI_V2.10.5.attachments/9165209288795990020.emf
[Abbildung-17]:          gemSpec_PKI_V2.10.5.attachments/12645155460962043521.emf
[Abbildung-18]:          gemSpec_PKI_V2.10.5.attachments/7613049471108825882.emf
[Abbildung-19]:          gemSpec_PKI_V2.10.5.attachments/13853463435789655221.png
[Abbildung-20]:          gemSpec_PKI_V2.10.5.attachments/12158266775686994033.png
[Abbildung-21]:          gemSpec_PKI_V2.10.5.attachments/8999448966524760507.emf
[Img-021]:               gemSpec_PKI_V2.10.5.attachments/11307977339773209788.png
[Tbl-001]:               #Tbl-001 (&93834768426424)
[Tbl-002]:               #Tbl-002 (&93834764878752)
[Tabelle-1]:             #Tabelle-1 (&93834764900704)
[Tabelle-2]:             #Tabelle-2 (&93834764908584)
[Tbl-005]:               #Tbl-005 (&93834764918336)
[Tbl-006]:               #Tbl-006 (&93834764934976)
[Tabelle-3]:             #Tabelle-3 (&93834772243216)
[Tabelle-4]:             #Tabelle-4 (&93834772280696)
[Tabelle-5]:             #Tabelle-5 (&93834777638888)
[Tabelle-6]:             #Tabelle-6 (&93834781759744)
[Tabelle-7]:             #Tabelle-7 (&93834781547280)
[Tabelle-8]:             #Tabelle-8 (&93834783488232)
[Tbl-013]:               #Tbl-013 (&93834783867072)
[Tabelle-9]:             #Tabelle-9 (&93834785392768)
[Tabelle-10]:            #Tabelle-10 (&93834785435208)
[Tabelle-11]:            #Tabelle-11 (&93834785696536)
[Tabelle-12]:            #Tabelle-12 (&93834785745648)
[Tabelle-13]:            #Tabelle-13 (&93834785780968)
[Tabelle-14]:            #Tabelle-14 (&93834785806280)
[Tabelle-15]:            #Tabelle-15 (&93834778316024)
[Tabelle-16]:            #Tabelle-16 (&93834765285176)
[Tabelle-17]:            #Tabelle-17 (&93834765327272)
[Tabelle-18]:            #Tabelle-18 (&93834783794776)
[Tabelle-19]:            #Tabelle-19 (&93834785591072)
[Tabelle-20]:            #Tabelle-20 (&93834764239600)
[Tabelle-21]:            #Tabelle-21 (&93834771301568)
[Tabelle-22]:            #Tabelle-22 (&93834771329704)
[Tabelle-23]:            #Tabelle-23 (&93834781321224)
[Tabelle-24]:            #Tabelle-24 (&93834768155824)
[Tabelle-25]:            #Tabelle-25 (&93834768364384)
[Tabelle-26]:            #Tabelle-26 (&93834778003352)
[Tabelle-27]:            #Tabelle-27 (&93834785012272)
[Tabelle-28]:            #Tabelle-28 (&93834785273408)
[Tabelle-29]:            #Tabelle-29 (&93834775992128)
[Tabelle-30]:            #Tabelle-30 (&93834776304352)
[Tabelle-31]:            #Tabelle-31 (&93834777394768)
[Tabelle-32]:            #Tabelle-32 (&93834765420968)
[Tabelle-33]:            #Tabelle-33 (&93834765673744)
[Tabelle-34]:            #Tabelle-34 (&93834765908072)
[Tabelle-35]:            #Tabelle-35 (&93834765932088)
[Tabelle-36]:            #Tabelle-36 (&93834776604688)
[Tabelle-37]:            #Tabelle-37 (&93834776832824)
[Tabelle-38]:            #Tabelle-38 (&93834777014224)
[Tabelle-39]:            #Tabelle-39 (&93834782916928)
[Tabelle-40]:            #Tabelle-40 (&93834783138400)
[Tabelle-41]:            #Tabelle-41 (&93834783359440)
[Tabelle-42]:            #Tabelle-42 (&93834770418400)
[Tabelle-43]:            #Tabelle-43 (&93834770628840)
[Tabelle-44]:            #Tabelle-44 (&93834770830016)
[Tabelle-45]:            #Tabelle-45 (&93834766368080)
[Tabelle-46]:            #Tabelle-46 (&93834766584328)
[Tabelle-47]:            #Tabelle-47 (&93834766801344)
[Tabelle-48]:            #Tabelle-48 (&93834767021696)
[Tabelle-49]:            #Tabelle-49 (&93834767175856)
[Tabelle-50]:            #Tabelle-50 (&93834767370168)
[Tabelle-51]:            #Tabelle-51 (&93834767612536)
[Tabelle-52]:            #Tabelle-52 (&93834778543272)
[Tabelle-53]:            #Tabelle-53 (&93834778720552)
[Tabelle-54]:            #Tabelle-54 (&93834778959520)
[Tabelle-55]:            #Tabelle-55 (&93834779427296)
[Tabelle-56]:            #Tabelle-56 (&93834779574648)
[Tabelle-57]:            #Tabelle-57 (&93834779612432)
[Tabelle-58]:            #Tabelle-58 (&93834779660544)
[Tabelle-59]:            #Tabelle-59 (&93834779694232)
[Tabelle-60]:            #Tabelle-60 (&93834779809088)
[Tabelle-61]:            #Tabelle-61 (&93834779844488)
[Tabelle-62]:            #Tabelle-62 (&93834779856120)
[Tabelle-63]:            #Tabelle-63 (&93834779890856)
[Tabelle-64]:            #Tabelle-64 (&93834779920152)
[Tabelle-65]:            #Tabelle-65 (&93834780007016)
[Tabelle-66]:            #Tabelle-66 (&93834780142928)
[Tabelle-67]:            #Tabelle-67 (&93834780230920)
[Tabelle-68]:            #Tabelle-68 (&93834780696696)
[Tabelle-69]:            #Tabelle-69 (&93834780783696)
[Tabelle-70]:            #Tabelle-70 (&93834780919952)
[Tabelle-71]:            #Tabelle-71 (&93834781011024)
[Tabelle-72]:            #Tabelle-72 (&93834781227128)
[Tabelle-73]:            #Tabelle-73 (&93834772390576)
[Tabelle-74]:            #Tabelle-74 (&93834772492304)
[Tabelle-75]:            #Tabelle-75 (&93834773433816)
[Tabelle-76]:            #Tabelle-76 (&93834773461440)
[Tabelle-77]:            #Tabelle-77 (&93834773557304)
[Tabelle-78]:            #Tabelle-78 (&93834774886456)
[Tabelle-79]:            #Tabelle-79 (&93834774902752)
[Tabelle-80]:            #Tabelle-80 (&93834774991400)
[Tabelle-81]:            #Tabelle-81 (&93834775051128)
[Tabelle-82]:            #Tabelle-82 (&93834775331216)
[Tabelle-83]:            #Tabelle-83 (&93834775417976)
[Tabelle-84]:            #Tabelle-84 (&93834775634992)
[Tabelle-85]:            #Tabelle-85 (&93834775686736)
[Tabelle-86]:            #Tabelle-86 (&93834775764456)
[Tabelle-87]:            #Tabelle-87 (&93834787164616)
[Tabelle-88]:            #Tabelle-88 (&93834787704192)
[Tabelle-89]:            #Tabelle-89 (&93834787941760)
[Tabelle-90]:            #Tabelle-90 (&93834788054792)
[Tabelle-91]:            #Tabelle-91 (&93834788167472)
[Tabelle-92]:            #Tabelle-92 (&93834788707096)
[Tabelle-93]:            #Tabelle-93 (&93834789220672)
[Tabelle-94]:            #Tabelle-94 (&93834789621512)
[Tabelle-95]:            #Tabelle-95 (&93834789954248)
[Tabelle-96]:            #Tabelle-96 (&93834790814256)
[Tabelle-97]:            #Tabelle-97 (&93834790899752)
[Tabelle-98]:            #Tabelle-98 (&93834791112928)
[Tabelle-99]:            #Tabelle-99 (&93834791217576)
[Tabelle-100]:           #Tabelle-100 (&93834791378680)
[Tabelle-101]:           #Tabelle-101 (&93834792374488)
[Tabelle-102]:           #Tabelle-102 (&93834792397808)
[Tabelle-103]:           #Tabelle-103 (&93834792459544)
[Tabelle-104]:           #Tabelle-104 (&93834792559744)
[Tabelle-105]:           #Tabelle-105 (&93834792610184)
[Tabelle-106]:           #Tabelle-106 (&93834792639208)
[Tabelle-107]:           #Tabelle-107 (&93834792671600)
[Tabelle-108]:           #Tabelle-108 (&93834792704336)
[Tabelle-109]:           #Tabelle-109 (&93834792737696)
[Tabelle-110]:           #Tabelle-110 (&93834792967728)
[Tabelle-111]:           #Tabelle-111 (&93834793199040)
[Tabelle-112]:           #Tabelle-112 (&93834793424608)
[Tabelle-113]:           #Tabelle-113 (&93834793446680)
[Tabelle-114]:           #Tabelle-114 (&93834793665536)
[Tabelle-115]:           #Tabelle-115 (&93834793885240)
[Tabelle-116]:           #Tabelle-116 (&93834793905512)
[Tabelle-117]:           #Tabelle-117 (&93834794124976)
[Tabelle-118]:           #Tabelle-118 (&93834794147488)
[Tabelle-119]:           #Tabelle-119 (&93834794388136)
[Tabelle-120]:           #Tabelle-120 (&93834794562744)
[Tbl-126]:               #Tbl-126 (&93834794783512)
[Tbl-127]:               #Tbl-127 (&93834795074240)
[Tbl-128]:               #Tbl-128 (&93834795256400)
[Tbl-129]:               #Tbl-129 (&93834795290640)
[Tabelle-121]:           #Tabelle-121 (&93834795799872)
[Tabelle-122]:           #Tabelle-122 (&93834796026184)
[Tabelle-123]:           #Tabelle-123 (&93834796252824)
[Tabelle-124]:           #Tabelle-124 (&93834796482376)
[Tabelle-125]:           #Tabelle-125 (&93834796707080)
[https://fachportal.gematik.de/]: https://fachportal.gematik.de/ (&93834770982624)
[RFC5280]:               http://tools.ietf.org/html/rfc3280 (&93834765257488)
[RFC5280]:               http://tools.ietf.org/html/rfc3280 (&93834765262304)
[http://uri.etsi.org/TrstSvc/Svcstatus/inaccord]: http://uri.etsi.org/TrstSvc/Svcstatus/inaccord (&93834773439296)
[http://uri.etsi.org/TrstSvc/Svcstatus/revoked]: http://uri.etsi.org/TrstSvc/Svcstatus/revoked (&93834773447504)
[http://uri.etsi.org/TrstSvc/Svcstatus/expired]: http://uri.etsi.org/TrstSvc/Svcstatus/expired (&93834773452496)
[http://uri.etsi.org/TrstSvc/Svctype/unspecified]: http://uri.etsi.org/TrstSvc/Svctype/unspecified (&93834787182344)
[http://uri.etsi.org/TrstSvc/Svctype/unspecified]: http://uri.etsi.org/TrstSvc/Svctype/unspecified (&93834787184808)
[http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP]: http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP (&93834791154856)
[http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP/QC]: http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP/QC (&93834791155632)
[]:                      file:///C:/Work/Work/QES-PruefungPolicy/20200407_Entwurf_KorrekturRefrenzen_PKI.docx#_msocom_2 (&93834791195176)
[<ServiceHistory>]:      file:///D:/Work/TSL/TSL-XML_ListIssueDateTime2019-11-21T14_20_00Z.xml (&93834791198016)
[http://uri.etsi.org/TrstSvc/TrustedList/SvcInfoExt/ForeSignatures]: http://uri.etsi.org/TrstSvc/TrustedList/SvcInfoExt/ForeSignatures (&93834791199096)
[https://www.sogis.eu/documents/cc/crypto/SOGIS-Agreed-Cryptographic-Mechanisms-1.1.pdf]: https://www.sogis.eu/documents/cc/crypto/SOGIS-Agreed-Cryptographic-Mechanisms-1.1.pdf (&93834795296176)
[http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf]: http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf (&93834795352336)
[http://tools.ietf.org/html/rfc2109]: http://tools.ietf.org/html/rfc2109 (&93834795720984)
[http://tools.ietf.org/html/rfc3629]: http://tools.ietf.org/html/rfc3629 (&93834795725616)
[http://tools.ietf.org/html/rfc3739]: http://tools.ietf.org/html/rfc3739 (&93834795730248)
[http://tools.ietf.org/html/rfc4514]: http://tools.ietf.org/html/rfc4514 (&93834795734880)
[http://tools.ietf.org/html/rfc5019]: http://tools.ietf.org/html/rfc5019 (&93834795739512)
[http://tools.ietf.org/html/rfc5280]: http://tools.ietf.org/html/rfc5280 (&93834795744240)
[https://tools.ietf.org/html/rfc6960]: https://tools.ietf.org/html/rfc6960 (&93834795748872)
[https://tools.ietf.org/html/rfc3370]: https://tools.ietf.org/html/rfc3370 (&93834795753440)
[http://www.itu.int/rec/T-REC-X.509/]: http://www.itu.int/rec/T-REC-X.509/ (&93834795766576)
[http://www.itu.int/rec/T-REC-X.520/]: http://www.itu.int/rec/T-REC-X.520/ (&93834795772416)
[http://www.w3.org/TR/REC-xml/]: http://www.w3.org/TR/REC-xml/ (&93834795782928)
[http://www.w3.org/TR/xmldsig-core/]: http://www.w3.org/TR/xmldsig-core/ (&93834795791288)
