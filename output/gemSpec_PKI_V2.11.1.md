...
Hinweis 1: Von dieser Regelung sind SM-B für Gesellschafterorganisationen (ohne
CVC) oder Kostenträger (Zugriffsprofil CHA.8 [gemSpec_PKI#Tab_PKI_254-01])
nicht betroffen, da sie keinen Zugriff auf die entsprechenden Daten erlauben.
Ebenso sind SM-B mit Zugriffsprofil CHA.1 [gemSpec_PKI#Tab_PKI_254-01) nicht
betroffen, da sie dem Zugriff des Versicherten selbst in der KTR-AdV-Umgebung
dienen.
...
Tabelle41: Tab_PKI_249 C.FD.TLS-C Client-Authentisierung
...
Tabelle42: Tab_PKI_250 C.FD.TLS-S Server-Authentisierung
Fachanwendungsspezifische Dienste
...
Tabelle43: Tab_PKI_251 C.FD.SIG Signatur fachanwendungsspezifische Dienste
...
Tabelle44: Tab_PKI_275  C.FD.AUT  Authentisierung  fachanwendungsspezifische
Dienste
...
Tabelle45: Tab_PKI_276 C.FD.ENC Verschlüsselung fachanwendungsspezifische
Dienste
...
Tabelle46: Tab_PKI_277 C.FD.OSIG Signatur fachanwendungsspezifische Dienste
(nonRepudiation)
...
Tabelle47: Tab_PKI_267 C.CM.TLS-CS Clientmodul-Authentisierung
...
Tabelle48: Tab_PKI_296  C.SGD-HSM.AUT  Authentisierung SGD-HSM
...
Tabelle49: Tab_PKI_211 GEM.R-CA\<n\> – Zentrale gematik Root-CA_nonQES der TI
...
Tabelle51: Tab_PKI_215 \<tsp\>.HBA-qCA\<n\> – Aussteller- CA_QES der TI
...
Hinweis: Neue OCSP-Signer-Zertifikate sollten gemäß [RFC6960] signiert
werden.Zu beachten ist, dass OCSP-Signer-Zertifikate zur Verwendung in der TI
in die TSL eingebracht werden müssen. (vgl. [gemSpec_TSL#TIP1-A_4084] sowie
TUC_PKI_006 „OCSP-Abfrage", Schritt 5.)
...
GS-A_4900-01 detailliert angegeben.
...
Tabelle53: Tab_PKI_214 C.GEM.CRL Zertifikatsprofil CRL-Signer
...
Tabelle54: Tab_PKI_252_01 C.TSL.SIG Zertifikatsprofil TSL-Signer
...
**GS-A_4621-01 - Zugriffsprofil von HBA und SM-B (SMC-B, HSM-B)**
...
Organisation gemäß Tabelle Tab_PKI_254-01 entspricht.     Eine Ausnahme
...
Der Kartenheraugeber für SM-B KTR-AdV MUSS sicherstellen, dass die
CV-Rollen-Zertifkate für eine KTR-AdV jeweils das Zugriffsprofil CHAT.1 bzw.
CHAT.0 gemäß [gemSpec_PKI#Tab_PKI_254-01] besitzen. **[\<=]**
...
Stelle“ (vgl. Tab_PKI_254-01) die Berechtigung für die Zugriffsprofile in
...
Praxis ärztlicher
Psychotherapeut) mit Autorisierung und Protokollierung gemäß  
§ 291a Abs. 5
Satz  
4 SGB V.  
...
bzw. Vorsorge- und Rehabilitationseinrichtung

nach SGB V § 107 Absatz 2 oder der medizinischen Rehabilitation nach SGB VI
oder der Heilbehandlung einschließlich medizinischer Rehabilitation nach SGB
VII.
...
Apotheker, für welche die gematik gemäß §340 Absatz 4 SGB V die Ausgabe
elektronischer Heilberufs- und Berufsausweise übernimmt.
...
Mitarbeiter von Apotheken mit Autorisierung und Protokollierung gemäß § 291a
Abs.5 Satz 4 SGB V.  
Apotheker, für welche die gematik gemäß §340 Absatz 4
SGB V die Ausgabe von Komponenten zur Authentifizierung von
Leistungserbringerinstitutionen übernimmt.  
Der „Mitarbeiter Apotheke"
...
Institutionen weiterer Berufsgruppe „Pflege“ mit SMC-B  
„Weitere Personen
der Pflege“ fallen unter diese Kategorie

</td><td>
Institution Sonstige Leistungserbringer
...
Gesundheitsfachberufe wie z.B. Notfallsanitäter
...
die Führung der
Berufsbezeichnung eine staatlich geregelte Ausbildung“ (§ 291a Abs. 4 Satz 1
Nr. 2e)  
absolviert haben.
...
**GS-A_5213-01 - CA-Flaglist für CVC-CA eines Profiltyps**
...
Rollen-Zugriffsprofilen) aus Tab_PKI_919-01,genau die zugeordnete Flaglist aus
...
aus Tab_PKI_919-01zulässig für die Zugriffsprofile(b.1) aller HBA- und SMC-B
...
Tabelle57: Tab_PKI_266 Aufbau CAR für Karten der Generation 2
...
Tabelle58: Tab_PKI_901 Objektidentifier des öffentlichen Schlüssels eines
...
Tabelle59: Tab_PKI_902 Punkt Q des öffentlichen Schlüssels eines
CV-Zertifikats der Generation 2
...
Tabelle Tab_PKI_910 (bei Anwendung von oid_cvc_fl_ti) oder Tab_PKI_911 (bei
...
Einzelflags gemäß TAB_PKI_918-01erfolgen.

Tabelle61: Tab_PKI_904 Mögliche Objektidentifier OID\<sub\>flags\</sub\>in
...
Tabelle62: Tab_PKI_905 Zu signierende Nachricht M eines CV-Zertifikates
...
Tabelle63: Tab_PKI_906 Signatur der Nachricht M eines CV-Zertifikats
...
Tabelle64: Tab_PKI_907 Struktur und Inhalt eines CV-Zertifikat
...
Zahnärztin/Zahnarzt ist in die Tabelle Tab_PKI_918-01 aufgenommen worden:
...
(siehe Tab_PKI_919-01).        Beispiel: Ein TSP-CVC ist nur für die
...
Flagliste einer Sub-CA beginnt mit der Bit-Folge ´10´ (vgl. Tab_PKI_910). Der
Wert für die Flagliste des CA-Zertifikates des TSP-CVC in Tab_PKI_919-01
...
ist für den Konnektor besonders geregelt (s. gemSpec_Kon#A_17837 und A_17784).
...
Tabelle77: TUC_PKI_001 „Periodische Aktualisierung TI-Vertrauensraum“
...
Tabelle78: TUC_PKI_013 „Import neuer TI-Vertrauensanker“
...
Tabelle81: TUC_PKI_017 „Lokalisierung Download-Adressen“
...
sind in [gemSpec_TSL#A_17680] zu finden.
...
Tabelle83: TUC_PKI_016 „Download der TSL-Datei“
...
Tabelle84: TUC_PKI_019 „Prüfung der Aktualität der TSL“
...
Tabelle85: TUC_PKI_020 „XML-Dokument validieren“
...
Tabelle86: TUC_PKI_011 „Prüfung des TSL-Signer-Zertifikates“
...
Tabelle87: TUC_PKI_012 „XML-Signatur- Prüfung“
...
Tabelle89: TUC_PKI_018 „Zertifikatsprüfung in der TI“
...
Tabelle90: TUC_PKI_002 „Gültigkeitsprüfung des Zertifikats“
...
Tabelle91: TUC_PKI_003 „CA-Zertifikat in TSL-Informationen finden“
...
Tabelle92: TUC_PKI_004 „Mathematische Prüfung der Zertifikatssignatur“
...
Tabelle93: TUC_PKI_005 „Adresse für Status- und Sperrprüfung ermitteln“
...
Tabelle94: TUC_PKI_006 „OCSP-Abfrage“
...
Tabelle95: TUC_PKI_021 „CRL-Prüfung“
...
[System:] Auswertung der Art der CRL. Es wird anhand der
IssuingDistributionPoint-Erweiterung in der Sperrliste (CRL) geprüft, ob es
sich um eine indirekte CRL handelt (indirectCRL-bit), s. [RFC5280] Kap. 5.2.5,
[X.509] Kap. 7.12..
...
Die Schritte 1-5 beinhalten die Validierung der CRL. Diese können vorgängig
durchgeführt werden und müssen also nicht bei jeder einzelnen CRL-Prüfung
eines End-Entity-Zertifikats durchlaufen werden, solange gewährleistet ist,
dass die CRL zeitlich gültig ist.
...
Tabelle96: TUC_PKI_009-01 „Rollenermittlung“
...
Tabelle97: TUC_PKI_007 „Prüfung Zertifikatstyp“
...
Tabelle98: Tab_PKI_273 Prüfparameter für TLS-Aufbau
...
Tabelle99: TUC_PKI_030 „QES-Zertifikatsprüfung“
...
Tabelle100: TUC_PKI_036 „BNetzA-VL Aktualisierung“
...
Tabelle102: Tab_PKI_908 Prüfung der Signatur eines CV-Zertifikats der
...
Tabelle103: Tab_PKI_909 Gültigkeit eines CV-Zertifikats der Generation 2 
...
Gemäß [gemKPT_PKI_TIP#TIP1-A_2140] muss die Schnittstelle zur
...
wird gemäß GS-A_4693 umgesetzt.
...
Tabelle105: Tab_PKI_289 Struktur Nonce
...
(vgl. [gemKPT_PKI_TIP#TIP1-A_2144]).
...
Tabelle106: Tab_PKI_291 OCSP-Response Status Ergebnisse
...
Tabelle107: Tab_PKI_292 Zeiten in einer OCSP-Response
...
Tabelle108: Tab_PKI_293 Status der OCSP Antworten
...
Tabelle109: Tab_PKI_288 Struktur certHash
...
\<oid_epa_ktr\> gemäß [gemSpec_OID#GS-A_4443-01]

professionOID = Genau eine  
OID \<oid_kostentraeger\> bzw.   
\<oid_epa_ktr\>
gemäß [gemSpec_OID#GS-A_4443-01]
...
professionItem = Beschreibung der Institution gemäß [gemSpec_OID#GS-A_4443-01]
...
professionOID = OID der Institution gemäß [gemSpec_OID#GS-A_4443-01]
...
\<oid_praxis-ernaehrungstherapeut\>  
gemäß [gemSpec_OID#GS-A_4443-03] 
...
- [Tabelle-46] - Tab_PKI_277 C.FD.OSIG Signatur fachanwendungsspezifische Dienste (nonRepudiation)
- [Tabelle-47] - Tab_PKI_267 C.CM.TLS-CS Clientmodul-Authentisierung
- [Tabelle-48] - Tab_PKI_296  C.SGD-HSM.AUT  Authentisierung SGD-HSM
- [Tabelle-49] - Tab_PKI_211 GEM.R-CA<n> – Zentrale gematik Root-CA_nonQES der TI
- [Tabelle-50] - Tab_PKI_212 <tsp>.<usage>-CA<n> –Aussteller- CA_nonQES der TI
- [Tabelle-51] -  Tab_PKI_215 <tsp>.HBA-qCA<n> – Aussteller- CA_QES der TI
- [Tabelle-52] - Tab_PKI_253 C.GEM.OCSP Zertifikatsprofil OCSP-Signer
- [Tabelle-53] - Tab_PKI_214 C.GEM.CRL Zertifikatsprofil CRL-Signer
- [Tabelle-54] - Tab_PKI_252_01 C.TSL.SIG Zertifikatsprofil TSL-Signer
- [Tabelle-55] - Tab_PKI_254-01 Zugriffsprofile für eine Rollenauthentisierung
- [Tabelle-56] - Tab_PKI_255 Zugriffsprofile G2 für eine Authentisierung einer Funktionseinheit
- [Tabelle-57] - Tab_PKI_266 Aufbau CAR für Karten der Generation 2
- [Tabelle-58] - Tab_PKI_901 Objektidentifier des öffentlichen Schlüssels eines CV-Zertifikats der Generation 2
- [Tabelle-59] - Tab_PKI_902 Punkt Q des öffentlichen Schlüssels eines CV-Zertifikats der Generation 2
- [Tabelle-60] - Tab_PKI_258 Aufbau CHR
- [Tabelle-61] - Tab_PKI_904 Mögliche Objektidentifier OID
- [Tabelle-62] - Tab_PKI_905 Zu signierende Nachricht M eines CV-Zertifikates
- [Tabelle-63] - Tab_PKI_906 Signatur der Nachricht M eines CV-Zertifikats
- [Tabelle-64] - Tab_PKI_907 Struktur und Inhalt eines CV-Zertifikat
- [Tabelle-65] - Tab_PKI_912 CA CV-Zertifikate für 256 bit ELC-Schlüssel, insgesamt 220 Oktett
- [Tabelle-66] - Tab_PKI_913 CA CV-Zertifikate für 384 bit ELC-Schlüssel, insgesamt 285 Oktett
- [Tabelle-67] - Tab_PKI_914 CA CV-Zertifikate für 512 bit ELC-Schlüssel, insgesamt 352 Oktett
- [Tabelle-68] - Tab_PKI_937 Cross-CV-Zertifikat für ELC-Schlüssel
- [Tabelle-69] - Tab_PKI_915 Endnutzer-CV-Zertifikate für 256 bit ELC-Schlüssel, insgesamt 222 Oktett
- [Tabelle-70] - Tab_PKI_916 Endnutzer-CV-Zertifikate für 384 bit ELC-Schlüssel, insgesamt 287 Oktett
- [Tabelle-71] - Tab_PKI_917 Endnutzer-CV-Zertifikate für 512 bit ELC-Schlüssel, insgesamt 354 Oktett
- [Tabelle-72] - Tab_PKI_910 TI-PKI, Bedeutung der Bits innerhalb der Flagliste eines CHAT
- [Tabelle-73] - Tab_PKI_918-01 Abbildung von Rollenberechtigungen Zugriffsprofilen auf äquivalente Flaglisten
- [Tabelle-74] - Tab_PKI_919-01 Sub-CA-Flaglisten nach Kartentyp (G2) und Zugriffsprofilen
- [Tabelle-75] - Tab_PKI_911 CMS-PKI, Bedeutung der Bits innerhalb der Flagliste eines CHAT
- [Tabelle-76] - Tab_PKI_271 Erlaubte URIs als Inhalte des TSL-Elements ServiceStatus
- [Tabelle-77] - TUC_PKI_001 „Periodische Aktualisierung TI-Vertrauensraum“
- [Tabelle-78] - TUC_PKI_013 „Import neuer TI-Vertrauensanker“
- [Tabelle-79] - Gültige Werte für den TI-Vertrauensankerwechsel
- [Tabelle-80] - Beispiel für den TSL-Eintrag zum Wechsel des TSL-Signer-CA-Zertifikats
- [Tabelle-81] - TUC_PKI_017 „Lokalisierung Download-Adressen“
- [Tabelle-82] - Tab_PKI_272 Gültige Werte zur Download-Adresse
- [Tabelle-83] - TUC_PKI_016 „Download der TSL-Datei“
- [Tabelle-84] - TUC_PKI_019 „Prüfung der Aktualität der TSL“
- [Tabelle-85] - TUC_PKI_020 „XML-Dokument validieren“
- [Tabelle-86] - TUC_PKI_011 „Prüfung des TSL-Signer-Zertifikates“
- [Tabelle-87] - TUC_PKI_012 „XML-Signatur- Prüfung“
- [Tabelle-88] - Tab_PKI_294 TSL Zeitparameter
- [Tabelle-89] - TUC_PKI_018 „Zertifikatsprüfung in der TI“
- [Tabelle-90] -  TUC_PKI_002 „Gültigkeitsprüfung des Zertifikats“
- [Tabelle-91] - TUC_PKI_003 „CA-Zertifikat in TSL-Informationen finden“
- [Tabelle-92] - TUC_PKI_004 „Mathematische Prüfung der Zertifikatssignatur“
- [Tabelle-93] - TUC_PKI_005 „Adresse für Status- und Sperrprüfung ermitteln“
- [Tabelle-94] - TUC_PKI_006 „OCSP-Abfrage“
- [Tabelle-95] - TUC_PKI_021 „CRL-Prüfung“
- [Tabelle-96] - TUC_PKI_009-01 „Rollenermittlung“
- [Tabelle-97] - TUC_PKI_007 „Prüfung Zertifikatstyp“
- [Tabelle-98] - Tab_PKI_273 Prüfparameter für TLS-Aufbau
- [Tabelle-99] - TUC_PKI_030 „QES-Zertifikatsprüfung“
- [Tabelle-100] - TUC_PKI_036 „BNetzA-VL Aktualisierung“
- [Tabelle-101] - Tab_PKI_274 Fehlercodes des SubCompTyps PKI bei TSL- und Zertifikatsprüfung
- [Tabelle-102] - Tab_PKI_908 Prüfung der Signatur eines CV-Zertifikats der Generation 2 mit Hilfe des CV-Zertifikats des Herausgebers
- [Tabelle-103] -  Tab_PKI_909 Gültigkeit eines CV-Zertifikats der Generation 2 
- [Tabelle-104] - Tab_PKI_290 Struktur certID in OCSP-Request/Response 
- [Tabelle-105] - Tab_PKI_289 Struktur Nonce
- [Tabelle-106] - Tab_PKI_291 OCSP-Response Status Ergebnisse
- [Tabelle-107] - Tab_PKI_292 Zeiten in einer OCSP-Response
- [Tabelle-108] - Tab_PKI_293 Status der OCSP Antworten
- [Tabelle-109] - Tab_PKI_288 Struktur certHash
- [Tabelle-110] - Tab_SMCB_KZBV_ZA SMC-B-Zertifikate für Zahnarzt (Sektor KZBV)
- [Tabelle-111] - Tab_SMCB_KV-T SMC-B-Zertifikate für Sektoren der KBV
- [Tabelle-112] - Tab_SMCB_DKTIG SMC-B-Zertifikate für Sektor der DKTIG
- [Tabelle-113] - Tab_SMCB_TID_DKTIG  Aufbau Telematik-ID in SMC-B-Zertifikaten der DKTIG
- [Tabelle-114] - Tab_SMB_KTR SM-B-Zertifikate für Mitarbeiter Kostenträger
- [Tabelle-115] - Tab_SMB_ADV_KTR SM-B-Zertifikate für die AdV-Umgebungen der Kostenträger
- [Tabelle-116] - Tab_SMB_TID_GKVSV Aufbau Telematik-ID in SM-B-Zertifikaten des GKV-SV
- [Tabelle-117] - Tab_SMCB_APO SMC-B-Zertifikate für Apotheker
- [Tabelle-118] - Tab_SMCB_TID_APO Aufbau Telematik-ID in SMC-B-Zertifikaten der Apotheker
- [Tabelle-119] - Tab_SMCB_ORG_Gen - Generisches Zertifikatsprofil für die SMC-B-ORG
- [Tabelle-120] - Tab_PKI_286-01 Generisches Zertifikatsprofil für die SMC-B - Weitere Leistungserbringerinstitution
- [Tabelle-121] -  Tab_PKI_287-01 Generisches Zertifikatsprofil für die SMC-B - Weitere Ärztliche Institutionen
- [Tabelle-122] - Tab_HBA_BÄK HBA-Zertifikate (AUT, ENC, QES) für BÄK
- [Tabelle-123] - Tab_HBA_BZÄK HBA-Zertifikate (AUT, ENC, QES) für BZÄK
- [Tabelle-124] - Tab_HBA_BPtK HBA-Zertifikate (AUT, ENC, QES) für BPtK
- [Tabelle-125] - Tab_HBA_APO HBA-Zertifikate (AUT, ENC, QES) für Apotheker
- [Tabelle-126] - Tab_PKI_285-01 Generisches Zertifikatsprofil (C.HP.AUT, C.HP.ENC, C.HP.QES) für HBA/BA - Weitere Leistungserbringer
...
\<logopaede-hpc\> bzw.  
\<podologe-hpc\> bzw.  
\<ernaehrungstherapeut-hpc\> 

gemäß [gemSpec_OID#GS-A_4442-02]  
professionOID = Genau eine OID der
Berufsgruppe:   
\<oid_altenpfleger-hpc\> bzw.  
\<oid_pflegefachkraft-hpc\>
bzw.  
...
\<oid_orthopaedietechniker-hpc\> bzw.  
\<oid_zahntechniker-hpc\> bzw. 
...
[4.7.2.2]:               #4722-separator
[4.7.2.3]:               #4723-fortsatz-der-telematik-id
...
[Abbildung-1]:           gemSpec_PKI_V2.11.1.attachments/9860334542679923714.emf
[Abbildung-3]:           gemSpec_PKI_V2.11.1.attachments/41448625434249942.emf
[Abbildung-4]:           gemSpec_PKI_V2.11.1.attachments/977682913005749266.wmf
[Abbildung-5]:           gemSpec_PKI_V2.11.1.attachments/2568216454139147218.emf
[Abbildung-6]:           gemSpec_PKI_V2.11.1.attachments/2832642052639720632.jpg
[Abbildung-7]:           gemSpec_PKI_V2.11.1.attachments/11515954078294821000.emf
[Abbildung-8]:           gemSpec_PKI_V2.11.1.attachments/8198595218391306627.emf
[Abbildung-9]:           gemSpec_PKI_V2.11.1.attachments/11413418770414368777.emf
[Abbildung-10]:          gemSpec_PKI_V2.11.1.attachments/697364341473611535.png
[Abbildung-11]:          gemSpec_PKI_V2.11.1.attachments/2773891538260872307.emf
[Img-011]:               gemSpec_PKI_V2.11.1.attachments/16430827375828737306.emf
[Abbildung-13]:          gemSpec_PKI_V2.11.1.attachments/9187492111909383948.emf
[Abbildung-14]:          gemSpec_PKI_V2.11.1.attachments/5291871770097294234.png
[Abbildung-15]:          gemSpec_PKI_V2.11.1.attachments/3869873291169113381.png
[Abbildung-16]:          gemSpec_PKI_V2.11.1.attachments/9165209288795990020.emf
[Abbildung-17]:          gemSpec_PKI_V2.11.1.attachments/12645155460962043521.emf
[Abbildung-18]:          gemSpec_PKI_V2.11.1.attachments/7613049471108825882.emf
[Abbildung-19]:          gemSpec_PKI_V2.11.1.attachments/13853463435789655221.png
[Abbildung-20]:          gemSpec_PKI_V2.11.1.attachments/12158266775686994033.png
[Abbildung-21]:          gemSpec_PKI_V2.11.1.attachments/8999448966524760507.emf
[Tbl-001]:               #Tbl-001 (&93834838692888)
[Tbl-002]:               #Tbl-002 (&93834799846192)
[Tabelle-1]:             #Tabelle-1 (&93834772234792)
[Tabelle-2]:             #Tabelle-2 (&93834772242656)
[Tbl-005]:               #Tbl-005 (&93834772252408)
[Tbl-006]:               #Tbl-006 (&93834836116408)
[Tabelle-3]:             #Tabelle-3 (&93834836130832)
[Tabelle-4]:             #Tabelle-4 (&93834764174280)
[Tabelle-5]:             #Tabelle-5 (&93834799934112)
[Tabelle-6]:             #Tabelle-6 (&93834810811008)
[Tabelle-7]:             #Tabelle-7 (&93834801660032)
[Tabelle-8]:             #Tabelle-8 (&93834796295384)
[Tbl-013]:               #Tbl-013 (&93834812088688)
[Tabelle-9]:             #Tabelle-9 (&93834838123480)
[Tabelle-10]:            #Tabelle-10 (&93834802327080)
[Tabelle-11]:            #Tabelle-11 (&93834783606816)
[Tabelle-12]:            #Tabelle-12 (&93834783656000)
[Tabelle-13]:            #Tabelle-13 (&93834811172208)
[Tabelle-14]:            #Tabelle-14 (&93834811197448)
[Tabelle-15]:            #Tabelle-15 (&93834783494776)
[Tabelle-16]:            #Tabelle-16 (&93834799232840)
[Tabelle-17]:            #Tabelle-17 (&93834789514608)
[Tabelle-18]:            #Tabelle-18 (&93834800951416)
[Tabelle-19]:            #Tabelle-19 (&93834776422800)
[Tabelle-20]:            #Tabelle-20 (&93834802623656)
[Tabelle-21]:            #Tabelle-21 (&93834781746952)
[Tabelle-22]:            #Tabelle-22 (&93834781775032)
[Tabelle-23]:            #Tabelle-23 (&93834764506104)
[Tabelle-24]:            #Tabelle-24 (&93834776267928)
[Tabelle-25]:            #Tabelle-25 (&93834771783912)
[Tabelle-26]:            #Tabelle-26 (&93834781552464)
[Tabelle-27]:            #Tabelle-27 (&93834783945648)
[Tabelle-28]:            #Tabelle-28 (&93834775789984)
[Tabelle-29]:            #Tabelle-29 (&93834811999704)
[Tabelle-30]:            #Tabelle-30 (&93834765334456)
[Tabelle-31]:            #Tabelle-31 (&93834796552368)
[Tabelle-32]:            #Tabelle-32 (&93834781240112)
[Tabelle-33]:            #Tabelle-33 (&93834796378016)
[Tabelle-34]:            #Tabelle-34 (&93834764312008)
[Tabelle-35]:            #Tabelle-35 (&93834764336120)
[Tabelle-36]:            #Tabelle-36 (&93834836686576)
[Tabelle-37]:            #Tabelle-37 (&93834836865504)
[Tabelle-38]:            #Tabelle-38 (&93834810958496)
[Tabelle-39]:            #Tabelle-39 (&93834781315136)
[Tabelle-40]:            #Tabelle-40 (&93834836252816)
[Tabelle-41]:            #Tabelle-41 (&93834793554512)
[Tabelle-42]:            #Tabelle-42 (&93834793715056)
[Tabelle-43]:            #Tabelle-43 (&93834811398576)
[Tabelle-44]:            #Tabelle-44 (&93834775208432)
[Tabelle-45]:            #Tabelle-45 (&93834775301488)
[Tabelle-46]:            #Tabelle-46 (&93834768628080)
[Tabelle-47]:            #Tabelle-47 (&93834775460720)
[Tabelle-48]:            #Tabelle-48 (&93834768120736)
[Tabelle-49]:            #Tabelle-49 (&93834768291944)
[Tabelle-50]:            #Tabelle-50 (&93834764646384)
[Tabelle-51]:            #Tabelle-51 (&93834771473712)
[Tabelle-52]:            #Tabelle-52 (&93834771716152)
[Tabelle-53]:            #Tabelle-53 (&93834776017528)
[Tabelle-54]:            #Tabelle-54 (&93834835721896)
[Tabelle-55]:            #Tabelle-55 (&93834835960688)
[Tabelle-56]:            #Tabelle-56 (&93834777808432)
[Tabelle-57]:            #Tabelle-57 (&93834777941544)
[Tabelle-58]:            #Tabelle-58 (&93834777979288)
[Tabelle-59]:            #Tabelle-59 (&93834778027520)
[Tabelle-60]:            #Tabelle-60 (&93834778061056)
[Tabelle-61]:            #Tabelle-61 (&93834778127192)
[Tabelle-62]:            #Tabelle-62 (&93834801037608)
[Tabelle-63]:            #Tabelle-63 (&93834801049240)
[Tabelle-64]:            #Tabelle-64 (&93834801133208)
[Tabelle-65]:            #Tabelle-65 (&93834801162464)
[Tabelle-66]:            #Tabelle-66 (&93834801249296)
[Tabelle-67]:            #Tabelle-67 (&93834801385216)
[Tabelle-68]:            #Tabelle-68 (&93834801473240)
[Tabelle-69]:            #Tabelle-69 (&93834769283320)
[Tabelle-70]:            #Tabelle-70 (&93834837628192)
[Tabelle-71]:            #Tabelle-71 (&93834837715456)
[Tabelle-72]:            #Tabelle-72 (&93834837855768)
[Tabelle-73]:            #Tabelle-73 (&93834838022552)
[Tabelle-74]:            #Tabelle-74 (&93834799387512)
[Tabelle-75]:            #Tabelle-75 (&93834799499792)
[Tabelle-76]:            #Tabelle-76 (&93834799780752)
[Tabelle-77]:            #Tabelle-77 (&93834777080440)
[Tabelle-78]:            #Tabelle-78 (&93834777176152)
[Tabelle-79]:            #Tabelle-79 (&93834835512200)
[Tabelle-80]:            #Tabelle-80 (&93834835528472)
[Tabelle-81]:            #Tabelle-81 (&93834777315296)
[Tabelle-82]:            #Tabelle-82 (&93834777375040)
[Tabelle-83]:            #Tabelle-83 (&93834777399776)
[Tabelle-84]:            #Tabelle-84 (&93834788953848)
[Tabelle-85]:            #Tabelle-85 (&93834789059736)
[Tabelle-86]:            #Tabelle-86 (&93834834802136)
[Tabelle-87]:            #Tabelle-87 (&93834789123640)
[Tabelle-88]:            #Tabelle-88 (&93834839263560)
[Tabelle-89]:            #Tabelle-89 (&93834839304648)
[Tabelle-90]:            #Tabelle-90 (&93834789154728)
[Tabelle-91]:            #Tabelle-91 (&93834789218512)
[Tabelle-92]:            #Tabelle-92 (&93834801964216)
[Tabelle-93]:            #Tabelle-93 (&93834776970568)
[Tabelle-94]:            #Tabelle-94 (&93834777032000)
[Tabelle-95]:            #Tabelle-95 (&93834800678664)
[Tabelle-96]:            #Tabelle-96 (&93834802949944)
[Tabelle-97]:            #Tabelle-97 (&93834803022328)
[Tabelle-98]:            #Tabelle-98 (&93834803714728)
[Tabelle-99]:            #Tabelle-99 (&93834803767768)
[Tabelle-100]:           #Tabelle-100 (&93834803921752)
[Tabelle-101]:           #Tabelle-101 (&93834804033672)
[Tabelle-102]:           #Tabelle-102 (&93834794686840)
[Tabelle-103]:           #Tabelle-103 (&93834794759360)
[Tabelle-104]:           #Tabelle-104 (&93834794821080)
[Tabelle-105]:           #Tabelle-105 (&93834794872120)
[Tabelle-106]:           #Tabelle-106 (&93834794922624)
[Tabelle-107]:           #Tabelle-107 (&93834794951728)
[Tabelle-108]:           #Tabelle-108 (&93834795033344)
[Tabelle-109]:           #Tabelle-109 (&93834795066032)
[Tabelle-110]:           #Tabelle-110 (&93834795099416)
[Tabelle-111]:           #Tabelle-111 (&93834795329344)
[Tabelle-112]:           #Tabelle-112 (&93834782070024)
[Tabelle-113]:           #Tabelle-113 (&93834782295360)
[Tabelle-114]:           #Tabelle-114 (&93834782317416)
[Tabelle-115]:           #Tabelle-115 (&93834782536240)
[Tabelle-116]:           #Tabelle-116 (&93834782706776)
[Tabelle-117]:           #Tabelle-117 (&93834782727072)
[Tabelle-118]:           #Tabelle-118 (&93834782946680)
[Tabelle-119]:           #Tabelle-119 (&93834782969288)
[Tabelle-120]:           #Tabelle-120 (&93834783210200)
[Tabelle-121]:           #Tabelle-121 (&93834783437416)
[Tbl-127]:               #Tbl-127 (&93834796836976)
[Tbl-128]:               #Tbl-128 (&93834797504560)
[Tbl-129]:               #Tbl-129 (&93834797638400)
[Tbl-130]:               #Tbl-130 (&93834797672744)
[Tabelle-122]:           #Tabelle-122 (&93834797885248)
[Tabelle-123]:           #Tabelle-123 (&93834798111208)
[Tabelle-124]:           #Tabelle-124 (&93834769414416)
[Tabelle-125]:           #Tabelle-125 (&93834769643800)
[Tabelle-126]:           #Tabelle-126 (&93834769868592)
[https://fachportal.gematik.de/]: https://fachportal.gematik.de/ (&93834793787344)
[RFC5280]:               http://tools.ietf.org/html/rfc3280 (&93834799205144)
[RFC5280]:               http://tools.ietf.org/html/rfc3280 (&93834799209952)
[http://uri.etsi.org/TrstSvc/Svcstatus/inaccord]: http://uri.etsi.org/TrstSvc/Svcstatus/inaccord (&93834799786232)
[http://uri.etsi.org/TrstSvc/Svcstatus/revoked]: http://uri.etsi.org/TrstSvc/Svcstatus/revoked (&93834799794360)
[http://uri.etsi.org/TrstSvc/Svcstatus/expired]: http://uri.etsi.org/TrstSvc/Svcstatus/expired (&93834799799352)
[http://uri.etsi.org/TrstSvc/Svctype/unspecified]: http://uri.etsi.org/TrstSvc/Svctype/unspecified (&93834839281200)
[http://uri.etsi.org/TrstSvc/Svctype/unspecified]: http://uri.etsi.org/TrstSvc/Svctype/unspecified (&93834839283672)
[http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP]: http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP (&93834803809760)
[http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP/QC]: http://uri.etsi.org/TrstSvc/Svctype/Certstatus/OCSP/QC (&93834803810536)
[]:                      file:///C:/Work/Work/QES-PruefungPolicy/20200407_Entwurf_KorrekturRefrenzen_PKI.docx#_msocom_2 (&93834803899264)
[<ServiceHistory>]:      file:///D:/Work/TSL/TSL-XML_ListIssueDateTime2019-11-21T14_20_00Z.xml (&93834803902104)
[http://uri.etsi.org/TrstSvc/TrustedList/SvcInfoExt/ForeSignatures]: http://uri.etsi.org/TrstSvc/TrustedList/SvcInfoExt/ForeSignatures (&93834803903184)
[https://www.sogis.eu/documents/cc/crypto/SOGIS-Agreed-Cryptographic-Mechanisms-1.2.pdf]: https://www.sogis.eu/documents/cc/crypto/SOGIS-Agreed-Cryptographic-Mechanisms-1.2.pdf (&93834797678280)
[http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf]: http://csrc.nist.gov/publications/fips/fips180-4/fips-180-4.pdf (&93834797734552)
[http://tools.ietf.org/html/rfc2109]: http://tools.ietf.org/html/rfc2109 (&93834797806352)
[http://tools.ietf.org/html/rfc3629]: http://tools.ietf.org/html/rfc3629 (&93834797810984)
[http://tools.ietf.org/html/rfc3739]: http://tools.ietf.org/html/rfc3739 (&93834797815616)
[http://tools.ietf.org/html/rfc4514]: http://tools.ietf.org/html/rfc4514 (&93834797820248)
[http://tools.ietf.org/html/rfc5019]: http://tools.ietf.org/html/rfc5019 (&93834797824880)
[http://tools.ietf.org/html/rfc5280]: http://tools.ietf.org/html/rfc5280 (&93834797829512)
[https://tools.ietf.org/html/rfc6960]: https://tools.ietf.org/html/rfc6960 (&93834797834144)
[https://tools.ietf.org/html/rfc3370]: https://tools.ietf.org/html/rfc3370 (&93834797838736)
[http://www.itu.int/rec/T-REC-X.509/]: http://www.itu.int/rec/T-REC-X.509/ (&93834797851872)
[http://www.itu.int/rec/T-REC-X.520/]: http://www.itu.int/rec/T-REC-X.520/ (&93834797857712)
[http://www.w3.org/TR/REC-xml/]: http://www.w3.org/TR/REC-xml/ (&93834797868328)
[http://www.w3.org/TR/xmldsig-core/]: http://www.w3.org/TR/xmldsig-core/ (&93834797876664)
