...
**A_18184 - Komponente Autorisierung Vers. - Prüfung auf
Vertretungsberechtigung für Prüfidentität**
...
(subject-id der AuthenticationAssertion != ActorID des Übergabeparameters
AuthorizationKey und ActorID des Übergabeparameters AuthorizationKey !=
OwnerKVNR)  prüfen, ob die Hinterlegung für eine Prüfidentität gemäß
[gemSpec_PK_eGK#Card-G2-A_3820] erfolgen soll und falls ja, den Anwendungsfall
mit dem Fehler TECHNICAL_ERROR abbrechen. **[\<=]**

Die Erkennung auf eine Prüfidentität kann über die Auswertung der ActorID des
zu berechtigenden Vertreters erfolgen, wobei diese als Prüf-KVNR anhand der
...
**A_14676-04 - Komponente Autorisierung -
...
angefragtenRecordIdentifierverfügbaren Verwaltungsprotokolleinträge
gemäß [gemSpec_DM_ePA#A_14471] zurückliefern, wenn der Wert
...
**A_21165-03 - Komponente Autorisierung -
...
**A_20481 - Komponente Autorisierung - Prüfen Umschlüsselungsberechtigung
startKeyChange**
...
der KVNR des Versicherten im übergebenen AuthorizationKey nicht übereinstimmt
mit dem unveränderlichen Teil der KVNR des Versicherten im bereits
gespeicherten AuthorizationKey. **[\<=]**

**A_20482-02 - Komponente Autorisierung - Sperren für
Autorisierungsoperationen**

DieKomponente Autorisierung MUSS für den ersten berechtigten Aufruf von
...
**A_20493 - Komponente Autorisierung - Prüfen Umschlüsselungsberechtigung
putForReplacement**
...
KVNR des Versicherten im übergebenenAuthorizationKeynicht übereinstimmt mit
dem unveränderlichen Teil der KVNR des Versicherten im bereits
gespeichertenAuthorizationKey. Wenn dieKEY_CHAIN sich nicht auf dem
...
**A_20487-03 - Komponente Autorisierung -
...
Zeitpunkt der erfolgreichen Umsetzung oder des Rollbacks
...
**A_20494 - Komponente Autorisierung - Prüfen Umschlüsselungsberechtigung
finishKeyChange**
...
der  Protokollierung gemäßgemSpec_DM_ePA#A_14505 einen Protokolleintrag
...
[Abbildung-1]:           gemSpec_Autorisierung_V1.9.0.attachments/15719297084117273851.bmp
[Abbildung-2]:           gemSpec_Autorisierung_V1.9.0.attachments/12032052280740721834.png
[Abbildung-3]:           gemSpec_Autorisierung_V1.9.0.attachments/16997383745116635923.png
[Abbildung-4]:           gemSpec_Autorisierung_V1.9.0.attachments/11133527811203100159.png
[Abbildung-5]:           gemSpec_Autorisierung_V1.9.0.attachments/5333311913823548744.png
[Abbildung-6]:           gemSpec_Autorisierung_V1.9.0.attachments/10285420410116400334.png
[Tbl-001]:               #Tbl-001 (&93834801496784)
[Tabelle-1]:             #Tabelle-1 (&93834801645192)
[Tabelle -2]:            #Tabelle -2 (&93834808794112)
[Tabelle-3]:             #Tabelle-3 (&93834780400400)
[Tabelle-4]:             #Tabelle-4 (&93834780439552)
[Tabelle-5]:             #Tabelle-5 (&93834810364984)
[Tabelle-6]:             #Tabelle-6 (&93834780383720)
[Tabelle-7]:             #Tabelle-7 (&93834783597616)
[Tabelle-8]:             #Tabelle-8 (&93834774963280)
[Tabelle-9]:             #Tabelle-9 (&93834798968528)
[Tabelle-10]:            #Tabelle-10 (&93834764474672)
[Tabelle-11]:            #Tabelle-11 (&93834798427856)
[Tabelle-12]:            #Tabelle-12 (&93834777639600)
[Tabelle-13]:            #Tabelle-13 (&93834781772104)
[Tabelle-14]:            #Tabelle-14 (&93834781536032)
[Tabelle-15]:            #Tabelle-15 (&93834781627688)
[Tabelle-16]:            #Tabelle-16 (&93834783536320)
[Tabelle-17]:            #Tabelle-17 (&93834785770160)
[Tabelle-18]:            #Tabelle-18 (&93834778304648)
[Tabelle-19]:            #Tabelle-19 (&93834799102528)
[Tabelle-20]:            #Tabelle-20 (&93834799178584)
[Tabelle-21]:            #Tabelle-21 (&93834783431824)
[Tabelle-22]:            #Tabelle-22 (&93834765282120)
[Tabelle-23]:            #Tabelle-23 (&93834765298840)
[Tabelle-24]:            #Tabelle-24 (&93834800075536)
[Tabelle -25]:           #Tabelle -25 (&93834783724864)
[Tabelle-26]:            #Tabelle-26 (&93834783751384)
[Tabelle-27]:            #Tabelle-27 (&93834775334160)
[Tabelle-28]:            #Tabelle-28 (&93834771324864)
[Tbl-030]:               #Tbl-030 (&93834781330064)
[Tbl-031]:               #Tbl-031 (&93834781353648)
[Tabelle-29]:            #Tabelle-29 (&93834781449560)
[Tabelle-30]:            #Tabelle-30 (&93834775446448)
[[gemSpec_DM_ePA#A_14471]]: https://polarion/polarion/#/project/FB_EPA/workitem?id=FBEP-5993 (&93834810839688)
[[gemSpec_DM_ePA#A_14471]]: https://polarion/polarion/#/project/FB_EPA/workitem?id=FBEP-5993 (&93834808791128)
[[gemSpec_DM_ePA#A_14471]]: https://polarion/polarion/#/project/FB_EPA/workitem?id=FBEP-5993 (&93834783526536)
[https://github.com/gematik/api-ePA]: https://github.com/gematik/api-ePA (&93834775442208)
[http://docs.oasis-open.org/security/saml/v2.0/]: http://docs.oasis-open.org/security/saml/v2.0/ (&93834775452712)
[https://www.w3.org/TR/soap12-part1/]: https://www.w3.org/TR/soap12-part1/ (&93834775456392)
[https://www.w3.org/TR/wsdl.html]: https://www.w3.org/TR/wsdl.html (&93834775460720)
[https://www.w3.org/Submission/wsdl11soap12/]: https://www.w3.org/Submission/wsdl11soap12/ (&93834775464864)
[http://ws-i.org/Profiles/BasicProfile-2.0-2010-11-09.html]: http://ws-i.org/Profiles/BasicProfile-2.0-2010-11-09.html (&93834775469192)
[http://docs.oasis-open.org/ws-sx/ws-trust/v1.4/errata01/os/ws-trust-1.4-errata01-os-complete.pdf]: http://docs.oasis-open.org/ws-sx/ws-trust/v1.4/errata01/os/ws-trust-1.4-errata01-os-complete.pdf (&93834775473040)
[http://www.oasis-open.org/committees/download.php/16790/wss-v1.1-spec-os-SOAPMessageSecurity.pdf]: http://www.oasis-open.org/committees/download.php/16790/wss-v1.1-spec-os-SOAPMessageSecurity.pdf (&93834775476704)
[https://www.oasis-open.org/committees/download.php/16768/wss-v1.1-spec-os-SAMLTokenProfile.pdf]: https://www.oasis-open.org/committees/download.php/16768/wss-v1.1-spec-os-SAMLTokenProfile.pdf (&93834775480848)
[http://docs.oasis-open.org/xspa/saml-xspa/v2.0/saml-xspa-v2.0.html]: http://docs.oasis-open.org/xspa/saml-xspa/v2.0/saml-xspa-v2.0.html (&93834775485176)
[https://tools.ietf.org/html/rfc5322]: https://tools.ietf.org/html/rfc5322 (&93834775493136)
[https://tools.ietf.org/html/rfc5280#page-71]: https://tools.ietf.org/html/rfc5280#page-71 (&93834775497768)
