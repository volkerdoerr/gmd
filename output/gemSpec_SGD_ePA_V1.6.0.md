...
Ein Client eines SGD-ePA MUSS, nachdem er die Prüfungen aus A_18031-*
...
Für die Verbesserung der UX in einem ePA-FdV wird die Mehrfachableitung dort
vorgeschrieben.

**A_23617 - ePA-FdV, SGD-Client, Mehrfachableitung**

Das ePA-Frontend des Versicherten (ePA-FdV) MUSS

 ---> OL

sicher aufbewahren und für die mehrmalige Verwendung im SGD-Protokoll
verfügbar halten und für die SGD-Nutzung des ePA-FdV verwenden. Nach Ablauf
der minimalen Gültigkeitsdauer der ECIES-SGD-Client-Schlüssel von 15 Minuten
MÜSSEN diese im ePA-FdV sicher gelöscht werden. **[\<=]**

Erläuterung:

Die ECIES-SGD-Client-Schlüssel werden im ePA-FdV zufällig erzeugt und jeweils
die öffentlichen Schlüssel der ECIES-SGD-Client-Schlüsselpaare werden mit
aktuellen gültigen (S4)-Schlüssel eines SGD1 und eines SGD2 (über deren
Hashwerte) durch eine Signatur auf Grundlage einer eGK oder einer
al.vi-Identität gebunden (vgl. Abschnitt "5.1.2 ECIES-Schlüssel eines
Clients").

Beispiel eines öffentlichen ECIES-SGD-Client-Schlüssels nach A_17900-*:
...
Diese Kodierung wird mittels einer eGK oder einer al.vi-Identität signiert. 

Nach Konstruktion ist die Nutzung dieses authentisierten öffentlichen
ECIES-SGD-Client-Schlüssels und dem dazugehörigen privaten Schlüssel
begrenzt durch die Gültigkeitsdauern der (S4)-Schlüssel (vgl. die Hashwerte
im Beispiel (vorletzte und letzte Datenelemente)). Diese (S4)-Schlüssel sind
-- technisch in den SGD durchgesetzt -- minimal 15 Minuten gültig und maximal
etwas weniger als 30 Minuten. Ein ePA-FdV geht nach A_23617 davon aus, dass es
gegen Ende einer Gültigkeit der (S4)-Schlüssel diese von den SGD bezogen hat
(also konservativer Ansatz). Die Nutzbarkeit ist damit noch 15 Minuten. Die
"Zeit-Information" (A_23617-*) stellt die Startzeit der Verwendbarkeit dar und
ermöglicht einem ePA-FdV festzustellen, ob zum Zeitpunkt der Schlüsselnutzung
die 15 Minuten schon abgelaufen sind oder nicht.
...
[Abbildung-1]:           gemSpec_SGD_ePA_V1.6.0.attachments/16072794315329523963.png
[Abbildung-2]:           gemSpec_SGD_ePA_V1.6.0.attachments/16366893780746780117.png
[Abbildung-3]:           gemSpec_SGD_ePA_V1.6.0.attachments/2402076656195963738.png
[Abbildung-4]:           gemSpec_SGD_ePA_V1.6.0.attachments/14187207369325910887.png
[Abbildung-5]:           gemSpec_SGD_ePA_V1.6.0.attachments/7030952575605585777.png
[Abbildung-6]:           gemSpec_SGD_ePA_V1.6.0.attachments/12144483419505098592.png
[Abbildung-7]:           gemSpec_SGD_ePA_V1.6.0.attachments/6596444674533073860.png
[Abbildung-8]:           gemSpec_SGD_ePA_V1.6.0.attachments/16474254148646190080.png
[Abbildung-9]:           gemSpec_SGD_ePA_V1.6.0.attachments/1826005387693765448.png
[Tbl-001]:               #Tbl-001 (&93834775873216)
[Tabelle -1]:            #Tabelle -1 (&93834801637104)
[Tabelle -2]:            #Tabelle -2 (&93834764152568)
[Tabelle -3]:            #Tabelle -3 (&93834799923168)
[Tabelle -4]:            #Tabelle -4 (&93834798435024)
[Tabelle -5]:            #Tabelle -5 (&93834772283104)
[Tabelle -6]:            #Tabelle -6 (&93834772305120)
[Tabelle -7]:            #Tabelle -7 (&93834781820944)
[Tabelle -8]:            #Tabelle -8 (&93834775777280)
[Tabelle -9]:            #Tabelle -9 (&93834781571680)
[Tabelle -10]:           #Tabelle -10 (&93834781610392)
[Tabelle -11]:           #Tabelle -11 (&93834775469120)
[Tabelle -12]:           #Tabelle -12 (&93834775483224)
[Tbl-014]:               #Tbl-014 (&93834775541664)
[Tbl-015]:               #Tbl-015 (&93834778276008)
[Tbl-016]:               #Tbl-016 (&93834778324832)
[Tbl-017]:               #Tbl-017 (&93834799133384)
[Tbl-018]:               #Tbl-018 (&93834765316064)
[Tbl-019]:               #Tbl-019 (&93834765346976)
[Tbl-020]:               #Tbl-020 (&93834799978576)
[https://download.tsl.ti-dienste.de/ECC/ROOT-CA/]: https://download.tsl.ti-dienste.de/ECC/ROOT-CA/ (&93834801566560)
[https://download.tsl.ti-dienste.de/ECC/Root-CA/roots.json]: https://download.tsl.ti-dienste.de/ECC/Root-CA/roots.json (&93834801568112)
